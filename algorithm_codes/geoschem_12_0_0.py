...
Svv_sparse_gc12_0_0, Sp_sparse_gc12_0_0, Sr_sparse_gc12_0_0, init_col_del_gc12_0_0 = del_zero_col(Svv_sparse_gc12_0_0, Sp_sparse_gc12_0_0, Sr_sparse_gc12_0_0)
...
rank_Svv_gc12_0_0_np = np.linalg.matrix_rank(Svv_gc12_0_0_np)
# Compute dimension of left null space by subtracting rank from the number of rows
dim_leftnull_gc12_0_0 = Svv_sparse_gc12_0_0.shape[0] - rank_Svv_gc12_0_0_np


# Identify sets of coproducing reactions
print("identifying coproduction columns...")
coproduction_cols_gc12_0_0 = create_coproduction(Sr_sparse_gc12_0_0)
# Create the dictionary of symbols for coproducing groups
print("creating symbolic dictionary...")
symbol_dict_gc12_0_0 = create_symbols(coproduction_cols_gc12_0_0, init_col_del_gc12_0_0)
# Perform the column "merging" operation on coproducting groups
print("merging coproduction columns...")
S_merge_gc12_0_0, col_del_gc12_0_0 = merge_coprod(Sr_sparse_gc12_0_0, Sp_sparse_gc12_0_0, symbol_dict_gc12_0_0, coproduction_cols_gc12_0_0, Svv_sparse_gc12_0_0)
print("performing linear algebra...")
# Compute the number of reactions lost due to merging
del_r_gc12_0_0 = S_merge_gc12_0_0.shape[1] - Svv_sparse_gc12_0_0.shape[1]
...
rank_list_gc12_0_0 = linalg_experiment(S_merge_gc12_0_0, num_experiments)
