...
Svv_sparse_gc12_9_0, Sp_sparse_gc12_9_0, Sr_sparse_gc12_9_0, init_col_del_gc12_9_0 = del_zero_col(Svv_sparse_gc12_9_0, Sp_sparse_gc12_9_0, Sr_sparse_gc12_9_0)
...
coproduction_cols_gc12_9_0 = create_coproduction(Sr_sparse_gc12_9_0)
# Create the dictionary of symbols for coproducing groups
print("creating symbolic dictionary...")
symbol_dict_gc12_9_0 = create_symbols(coproduction_cols_gc12_9_0, init_col_del_gc12_9_0)
# Perform the column "merging" operation on coproducting groups
print("merging coproduction columns...")
S_merge_gc12_9_0, col_del_gc12_9_0 = merge_coprod(Sr_sparse_gc12_9_0, Sp_sparse_gc12_9_0, symbol_dict_gc12_9_0, coproduction_cols_gc12_9_0, Svv_sparse_gc12_9_0)
print("performing linear algebra...")
# Compute the number of reactions lost due to merging
del_r_gc12_9_0 = S_merge_gc12_9_0.shape[1] - Svv_sparse_gc12_9_0.shape[1]
...
rank_list_gc12_9_0 = linalg_experiment(S_merge_gc12_9_0, num_experiments)
