...
Svv_sparse_pollu, Sp_sparse_pollu, Sr_sparse_pollu, init_col_del_pollu = del_zero_col(Svv_sparse_pollu, Sp_sparse_pollu, Sr_sparse_pollu)
...
symbol_dict_pollu = create_symbols(coproduction_cols_pollu, init_col_del_pollu)
