...
SUBROUTINE INTEGRATE( TIN,       TOUT,      ICNTRL_U, RCNTRL_U,  &
   ...
   USE chemuci_Util, ONLY : Integrator_Update_Options
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 USE chemuci_Parameters, ONLY : NVAR, LU_NONZERO
 USE chemuci_Global,     ONLY : FIX, RCONST, TIME
 USE chemuci_Function,   ONLY : Fun, Fun_SPLIT
 USE chemuci_Rates,      ONLY : Update_SUN, Update_RCONST
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 USE chemuci_Parameters,    ONLY : NVAR, LU_NONZERO
 USE chemuci_Global,        ONLY : FIX, RCONST, TIME
 USE chemuci_Jacobian,      ONLY : Jac_SP, LU_IROW, LU_ICOL
 USE chemuci_LinearAlgebra
 USE chemuci_Rates,         ONLY : Update_SUN, Update_RCONST
!~~~> Input variables
    REAL(kind=dp) :: T, Y(NVAR)
