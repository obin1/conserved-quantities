...
SUBROUTINE INTEGRATE( TIN,       TOUT,      ICNTRL_U, RCNTRL_U,  &
   ...
   USE CBMZ_Util, ONLY : Integrator_Update_Options
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 USE CBMZ_Parameters, ONLY : NVAR, LU_NONZERO
 USE CBMZ_Global,     ONLY : FIX, RCONST, TIME
 USE CBMZ_Function,   ONLY : Fun, Fun_SPLIT
 USE CBMZ_Rates,      ONLY : Update_SUN, Update_RCONST
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 USE CBMZ_Parameters,    ONLY : NVAR, LU_NONZERO
 USE CBMZ_Global,        ONLY : FIX, RCONST, TIME
 USE CBMZ_Jacobian,      ONLY : Jac_SP, LU_IROW, LU_ICOL
 USE CBMZ_LinearAlgebra
 USE CBMZ_Rates,         ONLY : Update_SUN, Update_RCONST
!~~~> Input variables
    REAL(kind=dp) :: T, Y(NVAR)
