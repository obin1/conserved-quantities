...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 ...
 USE CBMZ_Model
      ...
      REAL(kind=dp) V(67), F(2), RCT(142)
      REAL(kind=dp) JVS(636)
...
! Check for the right number of output arguments
     ...
     &JVS(636)')
      ...
      plhs(1) = mxCreateDoubleMatrix(636,1,0)

      VPtr = mxGetPr(prhs(1))
      CALL mxCopyPtrToReal8(VPtr,V,67)
      ...
      CALL mxCopyReal8ToPtr(JVS, JVSPtr, 636)
