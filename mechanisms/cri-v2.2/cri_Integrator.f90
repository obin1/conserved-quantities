...
SUBROUTINE INTEGRATE( TIN,       TOUT,      ICNTRL_U, RCNTRL_U,  &
   ...
   USE cri_Util, ONLY : Integrator_Update_Options
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 USE cri_Parameters, ONLY : NVAR, LU_NONZERO
 USE cri_Global,     ONLY : FIX, RCONST, TIME
 USE cri_Function,   ONLY : Fun, Fun_SPLIT
 USE cri_Rates,      ONLY : Update_SUN, Update_RCONST
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 USE cri_Parameters,    ONLY : NVAR, LU_NONZERO
 USE cri_Global,        ONLY : FIX, RCONST, TIME
 USE cri_Jacobian,      ONLY : Jac_SP, LU_IROW, LU_ICOL
 USE cri_LinearAlgebra
 USE cri_Rates,         ONLY : Update_SUN, Update_RCONST
!~~~> Input variables
    REAL(kind=dp) :: T, Y(NVAR)
