...
SUBROUTINE INTEGRATE( TIN,       TOUT,      ICNTRL_U, RCNTRL_U,  &
   ...
   USE mcm_Util, ONLY : Integrator_Update_Options
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 USE mcm_Parameters, ONLY : NVAR, LU_NONZERO
 USE mcm_Global,     ONLY : FIX, RCONST, TIME
 USE mcm_Function,   ONLY : Fun, Fun_SPLIT
 USE mcm_Rates,      ONLY : Update_SUN, Update_RCONST
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 USE mcm_Parameters,    ONLY : NVAR, LU_NONZERO
 USE mcm_Global,        ONLY : FIX, RCONST, TIME
 USE mcm_Jacobian,      ONLY : Jac_SP, LU_IROW, LU_ICOL
 USE mcm_LinearAlgebra
 USE mcm_Rates,         ONLY : Update_SUN, Update_RCONST
!~~~> Input variables
    REAL(kind=dp) :: T, Y(NVAR)
