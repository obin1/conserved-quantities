...
SUBROUTINE INTEGRATE( TIN,       TOUT,      ICNTRL_U, RCNTRL_U,  &
   ...
   USE gas_Util, ONLY : Integrator_Update_Options
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 USE gas_Parameters, ONLY : NVAR, LU_NONZERO
 USE gas_Global,     ONLY : FIX, RCONST, TIME
 USE gas_Function,   ONLY : Fun, Fun_SPLIT
 USE gas_Rates,      ONLY : Update_SUN, Update_RCONST
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 USE gas_Parameters,    ONLY : NVAR, LU_NONZERO
 USE gas_Global,        ONLY : FIX, RCONST, TIME
 USE gas_Jacobian,      ONLY : Jac_SP, LU_IROW, LU_ICOL
 USE gas_LinearAlgebra
 USE gas_Rates,         ONLY : Update_SUN, Update_RCONST
!~~~> Input variables
    REAL(kind=dp) :: T, Y(NVAR)
