...
! 
! File                 : isoprene_reduced_plus_v5_Global.f90
...
MODULE isoprene_reduced_plus_v5_Global

  USE isoprene_reduced_plus_v5_Parameters, ONLY: dp, NSPEC, NVAR, NFIX, NREACT, LU_NONZERO
  PUBLIC
  SAVE
...
END MODULE isoprene_reduced_plus_v5_Global
