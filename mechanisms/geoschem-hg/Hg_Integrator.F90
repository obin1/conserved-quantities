...
SUBROUTINE INTEGRATE( TIN,       TOUT,      ICNTRL_U, RCNTRL_U,  &
   ...
   USE Hg_Util, ONLY : Integrator_Update_Options
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 USE Hg_Parameters, ONLY : NVAR, LU_NONZERO
 USE Hg_Global,     ONLY : FIX, RCONST, TIME
 USE Hg_Function,   ONLY : Fun, Fun_SPLIT
 USE Hg_Rates,      ONLY : Update_SUN, Update_RCONST
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 USE Hg_Parameters,    ONLY : NVAR, LU_NONZERO
 USE Hg_Global,        ONLY : FIX, RCONST, TIME
 USE Hg_Jacobian,      ONLY : Jac_SP, LU_IROW, LU_ICOL
 USE Hg_LinearAlgebra
 USE Hg_Rates,         ONLY : Update_SUN, Update_RCONST
!~~~> Input variables
    REAL(kind=dp) :: T, Y(NVAR)
