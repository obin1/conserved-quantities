...
SUBROUTINE INTEGRATE( TIN,       TOUT,      ICNTRL_U, RCNTRL_U,  &
   ...
   USE jam_Util, ONLY : Integrator_Update_Options
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 USE jam_Parameters, ONLY : NVAR, LU_NONZERO
 USE jam_Global,     ONLY : FIX, RCONST, TIME
 USE jam_Function,   ONLY : Fun, Fun_SPLIT
 USE jam_Rates,      ONLY : Update_SUN, Update_RCONST
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 USE jam_Parameters,    ONLY : NVAR, LU_NONZERO
 USE jam_Global,        ONLY : FIX, RCONST, TIME
 USE jam_Jacobian,      ONLY : Jac_SP, LU_IROW, LU_ICOL
 USE jam_LinearAlgebra
 USE jam_Rates,         ONLY : Update_SUN, Update_RCONST
!~~~> Input variables
    REAL(kind=dp) :: T, Y(NVAR)
