...
! 
! File                 : isoprene_full_v5_nofixedspc_Global.f90
...
MODULE isoprene_full_v5_nofixedspc_Global

  USE isoprene_full_v5_nofixedspc_Parameters, ONLY: dp, NSPEC, NVAR, NFIX, NREACT, LU_NONZERO
  PUBLIC
  SAVE
...
END MODULE isoprene_full_v5_nofixedspc_Global
