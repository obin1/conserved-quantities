...
SUBROUTINE INTEGRATE( TIN,       TOUT,      ICNTRL_U, RCNTRL_U,  &
   ...
   USE RADM2_Util, ONLY : Integrator_Update_Options
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 USE RADM2_Parameters, ONLY : NVAR, LU_NONZERO
 USE RADM2_Global,     ONLY : FIX, RCONST, TIME
 USE RADM2_Function,   ONLY : Fun, Fun_SPLIT
 USE RADM2_Rates,      ONLY : Update_SUN, Update_RCONST
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 USE RADM2_Parameters,    ONLY : NVAR, LU_NONZERO
 USE RADM2_Global,        ONLY : FIX, RCONST, TIME
 USE RADM2_Jacobian,      ONLY : Jac_SP, LU_IROW, LU_ICOL
 USE RADM2_LinearAlgebra
 USE RADM2_Rates,         ONLY : Update_SUN, Update_RCONST
!~~~> Input variables
    REAL(kind=dp) :: T, Y(NVAR)
