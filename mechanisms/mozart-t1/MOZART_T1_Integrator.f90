...
SUBROUTINE INTEGRATE( TIN,       TOUT,      ICNTRL_U, RCNTRL_U,  &
   ...
   USE MOZART_T1_Util, ONLY : Integrator_Update_Options
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 USE MOZART_T1_Parameters, ONLY : NVAR, LU_NONZERO
 USE MOZART_T1_Global,     ONLY : FIX, RCONST, TIME
 USE MOZART_T1_Function,   ONLY : Fun, Fun_SPLIT
 USE MOZART_T1_Rates,      ONLY : Update_SUN, Update_RCONST
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 USE MOZART_T1_Parameters,    ONLY : NVAR, LU_NONZERO
 USE MOZART_T1_Global,        ONLY : FIX, RCONST, TIME
 USE MOZART_T1_Jacobian,      ONLY : Jac_SP, LU_IROW, LU_ICOL
 USE MOZART_T1_LinearAlgebra
 USE MOZART_T1_Rates,         ONLY : Update_SUN, Update_RCONST
!~~~> Input variables
    REAL(kind=dp) :: T, Y(NVAR)
...
END MODULE MOZART_T1_Integrator
