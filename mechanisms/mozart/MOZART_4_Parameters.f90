...
!   VAR(ind_spc) = C(ind_spc)
  ...
  INTEGER, PARAMETER :: ind_ISOPNO3 = 53 
  INTEGER, PARAMETER :: ind_GLYALD = 54 
  INTEGER, PARAMETER :: ind_ALKO2 = 55 
  INTEGER, PARAMETER :: ind_C2H5O2 = 56 
...
! NJVRP - Length of sparse Jacobian JVRP
  INTEGER, PARAMETER :: NJVRP = 333 

! NSTOICM - Length of Sparse Stoichiometric Matrix
  INTEGER, PARAMETER :: NSTOICM = 821 

END MODULE MOZART_4_Parameters
