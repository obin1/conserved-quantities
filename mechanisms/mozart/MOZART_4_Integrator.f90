...
SUBROUTINE INTEGRATE( TIN,       TOUT,      ICNTRL_U, RCNTRL_U,  &
   ...
   USE MOZART_4_Util, ONLY : Integrator_Update_Options
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 USE MOZART_4_Parameters, ONLY : NVAR, LU_NONZERO
 USE MOZART_4_Global,     ONLY : FIX, RCONST, TIME
 USE MOZART_4_Function,   ONLY : Fun, Fun_SPLIT
 USE MOZART_4_Rates,      ONLY : Update_SUN, Update_RCONST
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 USE MOZART_4_Parameters,    ONLY : NVAR, LU_NONZERO
 USE MOZART_4_Global,        ONLY : FIX, RCONST, TIME
 USE MOZART_4_Jacobian,      ONLY : Jac_SP, LU_IROW, LU_ICOL
 USE MOZART_4_LinearAlgebra
 USE MOZART_4_Rates,         ONLY : Update_SUN, Update_RCONST
!~~~> Input variables
    REAL(kind=dp) :: T, Y(NVAR)
...
END MODULE MOZART_4_Integrator
