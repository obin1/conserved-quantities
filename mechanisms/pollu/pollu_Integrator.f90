...
SUBROUTINE INTEGRATE( TIN,       TOUT,      ICNTRL_U, RCNTRL_U,  &
   ...
   USE pollu_Util, ONLY : Integrator_Update_Options
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 USE pollu_Parameters, ONLY : NVAR, LU_NONZERO
 USE pollu_Global,     ONLY : FIX, RCONST, TIME
 USE pollu_Function,   ONLY : Fun, Fun_SPLIT
 USE pollu_Rates,      ONLY : Update_SUN, Update_RCONST
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 USE pollu_Parameters,    ONLY : NVAR, LU_NONZERO
 USE pollu_Global,        ONLY : FIX, RCONST, TIME
 USE pollu_Jacobian,      ONLY : Jac_SP, LU_IROW, LU_ICOL
 USE pollu_LinearAlgebra
 USE pollu_Rates,         ONLY : Update_SUN, Update_RCONST
!~~~> Input variables
    REAL(kind=dp) :: T, Y(NVAR)
