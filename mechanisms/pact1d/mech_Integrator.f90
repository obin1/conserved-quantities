...
SUBROUTINE INTEGRATE( TIN,       TOUT,      ICNTRL_U, RCNTRL_U,  &
   ...
   USE mech_Util, ONLY : Integrator_Update_Options
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 USE mech_Parameters, ONLY : NVAR, LU_NONZERO
 USE mech_Global,     ONLY : FIX, RCONST, TIME
 USE mech_Function,   ONLY : Fun, Fun_SPLIT
 USE mech_Rates,      ONLY : Update_SUN, Update_RCONST
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 USE mech_Parameters,    ONLY : NVAR, LU_NONZERO
 USE mech_Global,        ONLY : FIX, RCONST, TIME
 USE mech_Jacobian,      ONLY : Jac_SP, LU_IROW, LU_ICOL
 USE mech_LinearAlgebra
 USE mech_Rates,         ONLY : Update_SUN, Update_RCONST
!~~~> Input variables
    REAL(kind=dp) :: T, Y(NVAR)
