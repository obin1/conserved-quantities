...
SUBROUTINE INTEGRATE( TIN,       TOUT,      ICNTRL_U, RCNTRL_U,  &
   ...
   USE RACM_Util, ONLY : Integrator_Update_Options
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 USE RACM_Parameters, ONLY : NVAR, LU_NONZERO
 USE RACM_Global,     ONLY : FIX, RCONST, TIME
 USE RACM_Function,   ONLY : Fun, Fun_SPLIT
 USE RACM_Rates,      ONLY : Update_SUN, Update_RCONST
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 USE RACM_Parameters,    ONLY : NVAR, LU_NONZERO
 USE RACM_Global,        ONLY : FIX, RCONST, TIME
 USE RACM_Jacobian,      ONLY : Jac_SP, LU_IROW, LU_ICOL
 USE RACM_LinearAlgebra
 USE RACM_Rates,         ONLY : Update_SUN, Update_RCONST
!~~~> Input variables
    REAL(kind=dp) :: T, Y(NVAR)
