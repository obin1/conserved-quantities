...
SUBROUTINE INTEGRATE( TIN,       TOUT,      ICNTRL_U, RCNTRL_U,  &
   ...
   USE superfast_Util, ONLY : Integrator_Update_Options
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 USE superfast_Parameters, ONLY : NVAR, LU_NONZERO
 USE superfast_Global,     ONLY : FIX, RCONST, TIME
 USE superfast_Function,   ONLY : Fun, Fun_SPLIT
 USE superfast_Rates,      ONLY : Update_SUN, Update_RCONST
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 USE superfast_Parameters,    ONLY : NVAR, LU_NONZERO
 USE superfast_Global,        ONLY : FIX, RCONST, TIME
 USE superfast_Jacobian,      ONLY : Jac_SP, LU_IROW, LU_ICOL
 USE superfast_LinearAlgebra
 USE superfast_Rates,         ONLY : Update_SUN, Update_RCONST
!~~~> Input variables
    REAL(kind=dp) :: T, Y(NVAR)
...
END MODULE superfast_Integrator
